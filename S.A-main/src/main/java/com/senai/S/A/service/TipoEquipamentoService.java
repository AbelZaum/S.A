...
public class TipoEquipamentoService {
    ...
    public TipoEquipamento atualizarTipo(Long id, TipoEquipamento tipoAtualizado) {
        ...
        tipo.setDescricao(tipoAtualizado.getDescricao()); // Atualiza a descrição
        tipo.setTipo(tipoAtualizado.getTipo()); // Atualiza o tipo
        return tipoEquipamentoRepository.save(tipo); // Salva as alterações
    }
